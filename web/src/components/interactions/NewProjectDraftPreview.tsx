// NewProjectDraftPreview (gm-ddpy.3 / gm-root.17.3).
//
// Shared interaction draft preview for the full-page Onboarder
// exception and any future RHP-hosted project-planning interaction.
// Renders the live plan tree (Milestones → Epics → Beads) and the
// draft project description. In-place edits feed back into
// NewProjectState so the next skill turn sees them.
//
...
export interface NewProjectDraftPreviewProps {
...
export function NewProjectDraftPreview({
  state,
  onEdit,
  disabled,
}: NewProjectDraftPreviewProps): JSX.Element {
