// NewProjectRatifyModal (gm-ddpy.3 / gm-root.17.3).
//
// Shared commit-review modal for Onboarder project-planning
// interactions. Surfaces the full plan tree + draft project.md for
// review and a single confirm button. The confirm POST carries a fresh
// X-GEMBA-Confirm nonce so a double-click can't double-write the
// project tree.
//
...
export interface NewProjectRatifyModalProps {
  open: boolean;
...
export function NewProjectRatifyModal({
  open,
  state,
  onConfirm,
  onCancel,
  committing,
  error,
}: NewProjectRatifyModalProps): JSX.Element | null {
