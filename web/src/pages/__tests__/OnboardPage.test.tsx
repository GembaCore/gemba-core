// OnboardPage host tests (was NewProjectPage gm-root.17.3; lifted to /onboard at gm-root.17.13) (gm-root.17.3). Covers session
...
// provider so OnboardPage tests render cleanly without a real
...
function wrap(): JSX.Element {
  return (
    <MemoryRouter initialEntries={['/new']}>
      <Routes>
        <Route path="/new" element={<OnboardPage />} />
...
describe('OnboardPage', () => {
  ...
  it('opens ratify modal, confirms, and shows the handoff screen', async () => {
    ...
    expect(screen.getByTestId("onboard-page").getAttribute('data-phase')).toBe('done');
  });
